...
- [x] 5.4 Implement `GET /.well-known/agent-skills/index.json` (v0.2.0 schema with `name`, `type`, `description`, `url`, `digest`) — unauthenticated
- [x] 5.4 Implement artifact serving endpoints: raw SKILL.md and tar.gz archive downloads
